...
class LoginView {
    ...
    private static $requestUsername = "LoginView::requestUsername";
	...
	public function getRequestUserName() {
      	...
      	if (isset($_COOKIE[self::$requestUsername]))
      	
                    return trim($_COOKIE[self::$requestUsername]);
	...
	public function SetRequestUsername($name) {
            ...
            setcookie(self::$requestUsername, $name,  time() + 2); 
        }
